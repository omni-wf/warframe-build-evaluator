...
document.getElementById("import-btn").onclick = function()
{
	...
	fetch("https://conduit.omni.wf/arsenal?account="+encodeURIComponent(document.querySelector("input[type='text']").value)+"&platform="+document.querySelector("select").value)
